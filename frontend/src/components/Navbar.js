  ...
  return (
    <div className='nav'>
                ...
                <div className='searched'>
                  <div className='searchedItem' key={product._id}>
                    ...
                    <div className='searchItem-inner'>
                      ...
                      <span>
                        {/* display the brand name in search bar */}
      ...
      <div className='extra-items' id='extraitems'>
        ...
        {/* All the main and sub categories */}
        <ul className='shopping-categories'>
          <li className='inline-items'>
            <Link to='/categories/Electronics'>Haircut</Link>
            {/* <ul className='inline-list'>
              ...
              <li>
                <Link to='/category/Mobile'>Women's haircut</Link>
              </li>
            </ul> */}
          </li>
          <li className='inline-items'>
            <Link to='/categories/Men Fashion'>Massage</Link>
            {/* <ul className='inline-list'>
              <li>
                <Link to='/category/Shirt'>Swedish Massage</Link>
              </li>
              <li>
                <Link to='/category/Paint'>Deep Tissue Massage</Link>
              </li>
            </ul> */}
          </li>
          <li className='inline-items'>
            <Link to='/categories/Women Fashion'>Nails</Link>
            {/* <ul className='inline-list'>
              <li>
                <Link to='/category/Kurta'>Menicure</Link>
              </li>
              <li>
                <Link to='/category/Saree'>Pedicure</Link>
              </li>
            </ul> */}
          </li>
          <li className='inline-items'>
            <Link to='/categories/Groceries'>Facials</Link>
            {/* <ul className='inline-list'>
              <li>
                <Link to='/category/Rice'>Gold</Link>
              </li>
              <li>
                <Link to='/category/Cereals'>Platinum</Link>
              </li>
            </ul> */}
          </li>
          <li className='inline-items'>
            <Link to='/categories/Lifestyle'>Products</Link>
            {/* <ul className='inline-list'>
              <li>
                <Link to='/category/Shampoo'>Shampoo</Link>
              </li>
              <li>
                <Link to='/category/Deodrants'>Cosmetics</Link>
              </li>
            </ul> */}
          </li>
        </ul>
